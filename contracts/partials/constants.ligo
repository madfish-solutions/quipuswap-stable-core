...
const default_token_metadata: map(string, bytes) = map [
  "name" -> 0x537461626c652044455820517569707553776170204c5020746f6b656e;//Bytes.pack("Stable DEX QuipuSwap LP token");
  "symbol" -> 0x736451504c50;//Bytes.pack("sdQPLP");
  "decimals" -> 0x3138;
  "description" -> 0x4c697175696469747920506f6f6c20746f6b656e206f662051756970755377617020537461626c6520444558;//Bytes.pack("Liquidity Pool token of QuipuSwap Stable DEX");
  "shouldPreferSymbol" -> 0x74727565;//Bytes.pack("true");
  "thumbnailUri" -> 0x697066733a2f2f516d5558464a787747456a6b6e5035444b4e774d777357587672593847326a554d62786a64424533656b50384450;//Bytes.pack("ipfs://QmUXFJxwGEjknP5DKNwMwsWXvrY8G2jUMbxjdBE3ekP8DP");
];
